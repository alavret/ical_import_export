...
4. При первом запуске скрипта перейдите в пункт `9. Настройка сервисного приложения.` и выберите `2. Настроить сервисное приложение.` Это корректно настроит сервисное приложение для работы скрипта.
